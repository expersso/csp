...
Since the Correlates of State Policy project now provides their data in an
easy-to-use CSV file, this package is deprecated. To read the data into R, just
use:
...
See [their website](http://ippsr.msu.edu/public-policy/correlates-state-policy) 
